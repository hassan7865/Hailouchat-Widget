...
export const WelcomeScreen: React.FC<WelcomeScreenProps> = ({ onStartChat, loading }) => {
  return (
    <div className="flex-1 flex flex-col items-center justify-center p-4 sm:p-8 bg-gradient-to-b from-blue-50 to-white">
      <div className="w-16 h-16 sm:w-20 sm:h-20 bg-gradient-to-r from-blue-500 to-blue-600 rounded-full flex items-center justify-center mb-4 sm:mb-6">
